...
void Main() {
	...
	Basic::UWorld_Offset = g_Scanner->FindPattern(basemodule, skCrypt("\x48\x8B\x05\x00\x00\x00\x00\x4D\x8B\xC2"), skCrypt("xxx????xxx????"), 0);
	...
	PBYTE addr = (PBYTE)(DWORD64)GetModuleHandleW(NULL) + 0x79104B0; //maybe wrong
